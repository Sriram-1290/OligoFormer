...
my $runcmd = "/d/teleparadigm/OligoFormer/off-target/pita/lib/pita_run.pl -utr $utr_fn -mir $mir_fn -prefix ${prefix}_ " . 
...
system "rm ${prefix}_ext_utr.stab; mv ${prefix}_pita_results.tab tmp_${pid}; head -n 1 tmp_${pid} | cut -f 1-5,8,10- > ${prefix}_pita_results.tab; cat tmp_${pid} | /d/teleparadigm/OligoFormer/off-target/pita/lib/body.pl 2 -1 | tr -d '\r' | cut -f 1-8,10- | /d/teleparadigm/OligoFormer/off-target/pita/lib/merge_columns.pl -1 4 -2 5 -d ':' | /d/teleparadigm/OligoFormer/off-target/pita/lib/merge_columns.pl -1 4 -2 5 -d ':' | sed 's/Seed:Mismatchs:G:U/Seed/g' | sort -k 13n >> ${prefix}_pita_results.tab; rm tmp_${pid};";

system "cat ${prefix}_pita_results.tab | /d/teleparadigm/OligoFormer/off-target/pita/lib/body.pl 2 -1 | cut -f 1,2,13 | /d/teleparadigm/OligoFormer/off-target/pita/lib/modify_column.pl -c 2 -m '\"-1\"' | /d/teleparadigm/OligoFormer/off-target/pita/lib/average_rows.pl -k 0,1 -losoe -n | /d/teleparadigm/OligoFormer/off-target/pita/lib/cut.pl -f 2,3,1,4 | /d/teleparadigm/OligoFormer/off-target/pita/lib/modify_column.pl -c 3 -m '\"-1\"' | /d/teleparadigm/OligoFormer/off-target/pita/lib/modify_column.pl -c 3 -p 2 | sort -k 4n | /d/teleparadigm/OligoFormer/off-target/pita/lib/cap.pl \"RefSeq,microRNA,Sites,Score\" > ${prefix}_pita_results_targets.tab";
...
if ($gxp == 1)
{
   ...
   system "/d/teleparadigm/OligoFormer/off-target/pita/lib/fasta2stab.pl $utr_fn | /d/teleparadigm/OligoFormer/off-target/pita/lib/stab2length.pl | /d/teleparadigm/OligoFormer/off-target/pita/lib/lin.pl | /d/teleparadigm/OligoFormer/off-target/pita/lib/add_column.pl -s 0 | /d/teleparadigm/OligoFormer/off-target/pita/lib/cut.pl -f 2,1,4,3 | /d/teleparadigm/OligoFormer/off-target/pita/lib/add_column.pl -s 0 | /d/teleparadigm/OligoFormer/off-target/pita/lib/add_column.pl -s 1 | /d/teleparadigm/OligoFormer/off-target/pita/lib/tab2feature_gxt.pl -n 'UTR Sequences' >> ${prefix}_pita_results.gxp";
   system "/d/teleparadigm/OligoFormer/off-target/pita/lib/body.pl 2 -1 ${prefix}_pita_results.tab | tr -d '\r' | /d/teleparadigm/OligoFormer/off-target/pita/lib/cut.pl -f 1-4,2,14 | /d/teleparadigm/OligoFormer/off-target/pita/lib/uniquify.pl -c 1 | /d/teleparadigm/OligoFormer/off-target/pita/lib/tab2feature_gxt.pl -n 'PITA Predictions' -c '0,0,255,1'  -lh 50 -l 'Filled box' -minc '0' -maxc '25' >> ${prefix}_pita_results.gxp";
