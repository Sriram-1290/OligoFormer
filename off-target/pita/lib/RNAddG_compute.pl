...
my $RNAHYBRID_EXE_DIR = "/d/teleparadigm/OligoFormer/off-target/pita/Bin/RNAHybrid/RNAhybrid-2.1/src";
my $RNAddG_EXE_DIR 		= "/d/teleparadigm/OligoFormer/off-target/pita/Bin/ViennaRNA/ViennaRNA-1.6/Progs/";
...
/d/teleparadigm/OligoFormer/off-target/pita/lib/RNAddG_compute.pl <file>
